        ...
        <div class="card-body">
            <div class="live-preview">
                <form class="row g-3 needs-validation" novalidate enctype='multipart/form-data'
                    action="<?php echo e(route('teams.update', $team->id)); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-label-group in-border">
                            <input type="text"
                                ...
                                name="name" placeholder="Please enter" value="<?php echo e($team->name); ?>" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-label-group in-border">
                            <input type="number"
                                ...
                                value="<?php echo e($team->number_of_members); ?>" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-label-group in-border">
                            <select class="form-select form-control mb-3" name="status_id" required>
                                <option value="" <?php if($team->stat_id == ''): ?> <?php echo e('selected'); ?> <?php endif; ?>
                                    selected disabled>
                                    Select One
                                </option>
                                <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($status->id); ?>"
                                        <?php if($team->status_id == $status->id): ?> <?php echo e('selected'); ?> <?php endif; ?>>
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="form-label-group in-border">
                            ...
                            <input type="file"
                                ...
                                name="team_logo" placeholder="" value="<?php echo e($team->teamogo); ?>">
...
<?php /**PATH C:\laragon\www\tournament-setup\resources\views/settings/teams/edit.blade.php ENDPATH**/ ?>