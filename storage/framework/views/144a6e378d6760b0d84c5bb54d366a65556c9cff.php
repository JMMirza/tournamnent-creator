    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="live-preview">
                <form class="row g-3 needs-validation" novalidate action="<?php echo e(route('gamer-tags.store')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <div class="col-md-4">
                        <div class="form-label-group in-border">
                            <input type="text"
                                class="form-control <?php if($errors->has('name')): ?> is-invalid <?php endif; ?>"
                                id="gamerTagName" name="name" placeholder="Please enter" value="<?php echo e(old('name')); ?>"
                                required>
...
<?php /**PATH C:\laragon\www\tournament-setup\resources\views/settings/gamer_tags/add_new.blade.php ENDPATH**/ ?>