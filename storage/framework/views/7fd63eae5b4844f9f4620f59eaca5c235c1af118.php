        ...
        <div class="card-body">
            <div class="live-preview">
                <form class="row g-3 needs-validation" novalidate
                    action="<?php echo e(route('tournaments.update', $tournament->id)); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-label-group in-border">
                            <input type="text"
                                ...
                                name="name" placeholder="Please enter" value="<?php echo e($tournament->name); ?>" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-label-group in-border">
                            <select class="form-select form-control mb-3" name="published" required>
                                <option value="" <?php if($tournament->published == ''): ?> <?php echo e('selected'); ?> <?php endif; ?>
                                    selected disabled>
                                    Select One
                                </option>
                                <option value="1" <?php if($tournament->published == '1'): ?> <?php echo e('selected'); ?> <?php endif; ?>>
                                    Yes
                                </option>
                                <option value="0" <?php if($tournament->published == '0'): ?> <?php echo e('selected'); ?> <?php endif; ?>>
                                    No
                                </option>
                            </select>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-label-group in-border">
                            <input type="date" name="start_date" value="<?php echo e($tournament->start_date); ?>"
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-label-group in-border">
                            <input type="date" name="end_date" value="<?php echo e($tournament->end_date); ?>"
                    ...
                    <div class="col-md-4">
                        <div class="form-label-group in-border">
                            <input type="number"
                                ...
                                value="<?php echo e($tournament->number_of_request); ?>" required>
                        ...
                        <div class="form-label-group in-border">
                            <div class="input-group">
                                <input type="number"
                                    ...
                                    value="<?php echo e($tournament->registration_fee); ?>">
                    ...
                    <div class="col-md-4">
                        <div class="form-label-group in-border">
                            <select class="form-select form-control mb-3" name="status_id" required>
                                <option value="" <?php if($tournament->status_id == ''): ?> <?php echo e('selected'); ?> <?php endif; ?>
                                    selected disabled>
                                    Select One
                                </option>
                                <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($status->id); ?>"
                                        <?php if($tournament->status_id == $status->id): ?> <?php echo e('selected'); ?> <?php endif; ?>>
                    ...
                    <div class="col-md-12 col-sm-12 mb-3">
                        <div id="snow-editor" style="height: 300px;"><?php echo $tournament->terms_and_condition; ?></div>
...
<?php /**PATH C:\laragon\www\tournament-setup\resources\views/settings/tournaments/edit.blade.php ENDPATH**/ ?>